    ...
    <div v-for="command in commands" :key="command">
      <div class="d-flex justify-content-between shadow rounded p-3 m-3 bg-white AVenirCard text-start text-dark">
        ...
        <div class="d-flex align-items-center">
          <button class="btn" @click="commandDone(command.id)"><svg class="m-1 bd-highlight" xmlns="http://www.w3.org/2000/svg" width="34.875" height="34.875" viewBox="0 0 34.875 34.875">
